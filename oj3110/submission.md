...
```text
Input:
บรรทัด1 ต้นทาง-ปลายทาง
บรรทัด2 น้ำหนักพัสดุ
Output:
ถ้าเส้นทางตรงกับตารางคิด ค่าเริ่มต้น + ค่ากก.×น้ำหนัก ทศนิยม 2 ตำแหน่ง ถ้าไม่ตรงพิมพ์ Error
Constraints:
เส้นทางมีทิศทาง (สลับกันไม่ได้), น้ำหนักอาจเป็น float, ต้องโชว์ทศนิยม 2 ตำแหน่งเสมอ
```
...
Step 2: อ่านน้ำหนักพัสดุ
Step 3: เก็บตารางเส้นทางไว้ใน dictionary (key = คู่ต้นทาง-ปลายทาง)
Step 4: เช็คว่าคู่ที่รับมาตรงกับ key ในตารางไหม
Step 5: ถ้าตรง คำนวณ ค่าเริ่มต้น + ค่ากก.×น้ำหนัก แล้วพิมพ์ทศนิยม 2 ตำแหน่ง
Step 6: ถ้าไม่ตรง พิมพ์ Error
```
...
```text
เหมือนวิธีแรก เพราะลองทดสอบตามสูตรที่ลองใช้ดูแล้วoutputถูกต้อง
```
