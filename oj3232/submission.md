...
```text
Input:
รับจำนวนเต็ม 2 ค่า คือ X ระยะกระโดดครั้งแรก และ Y ระยะทางเป้าหมาย
Output:
แสดงจำนวนครั้งที่กระโดดน้อยที่สุดที่ระยะรวมถึงหรือเกิน Y ถ้าไปไม่ถึงให้แสดง -1
Constraints:
X อยู่ระหว่าง 1-1000 และ Y อยู่ระหว่าง 1-100000 โดยระยะกระโดดจะลดลงครั้งละ 2 เมตรจนไม่สามารถกระโดดต่อได้
```
...
Step2: ให้ระยะกระโดดครั้งแรกเท่ากับ X และเริ่มนับจำนวนครั้งเป็น 0
Step3: บวกแต่ละระยะกระโดดเข้ากับระยะทางรวม แล้วเพิ่มจำนวนครั้ง
Step4: ลดระยะกระโดดครั้งต่อไปลง 2 เมตร
Step5: ถ้าระยะรวมถึงหรือเกิน Y ให้แสดงจำนวนครั้งที่กระโดด
Step6: ถ้าระยะกระโดดลดจนเป็น 0 หรือต่ำกว่าแล้วยังไม่ถึง Y ให้แสดง -1
```
