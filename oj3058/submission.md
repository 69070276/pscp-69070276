...
Output:
แสดงจำนวนอิฐก้อนเล็กที่ต้องใช้
หากสร้างสะพานให้ยาวเท่ากับ goal ไม่ได้ ให้แสดง -1
Constraints:
ใช้อิฐก้อนใหญ่ให้มากที่สุดก่อน แล้วจึงใช้อิฐก้อนเล็ก
ต้องสร้างสะพานให้มีความยาวเท่ากับ goal พอดี หากอิฐก้อนเล็กไม่พอสำหรับความยาวที่เหลือ ให้ตอบ -1
```
...
```text
Step1: รับค่า a, b และ goal
Step2: ใช้อิฐก้อนใหญ่ให้ได้มากที่สุดโดยไม่เกิน goal แล้วคำนวณความยาวที่เหลือ
Step3: ถ้าจำนวนอิฐก้อนเล็กพอสำหรับความยาวที่เหลือ ให้พิมพ์จำนวนอิฐก้อนเล็กที่ใช้  นอกนั้นพิมพ์-1
```
...
```text
เหมือนวิธีแรก เพราะเป็นวิธีที่เข้าใจ
```
