...
```text
Input:
โปรแกรมรับตัวเลข price จากผู้ใช้ผ่าน input เป็น float เป็นจำนวนเงินรวมค่าอาหารและเครื่องดื่ม

Output:
โปรแกรมพิมพ์จำนวนเงินสุดท้ายที่ลูกค้าต้องจ่าย หลังจากรวมค่าบริการและ VAT แล้ว โดยแสดงผลเป็นทศนิยม 2 ตำแหน่ง

Constraints:
- ค่าบริการคิด 10% ของ price แต่ต้องไม่ต่ำกว่า 50 และไม่เกิน 1000 ถ้า 10% ของ price น้อยกว่า 50 ให้ใช้ 50 แทน ถ้ามากกว่า 1000 ให้ใช้ 1000 แทน
- VAT คิด 7% ของ price + ค่าบริการ
- จำนวนเงินสุดท้าย = price + ค่าบริการ + VAT
- ต้องพิมพ์ผลลัพธ์เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1:รับinputแทนราคา
Step 2:เอาไปบวกกับค่าบริการและVATตามที่โจทย์กำหนด
Step 3:printออกมาโดยให้มีทศนิยม2ตำแหน่ง
```
...
```text
เหมือนกัน เพราะว่าอ่านโจทย์และเข้าใจว่าโจทย์ต้องการให้ทำอะไร
```
...
```text
ต้องการดูว่าoutputตรงกับในtestcaseมั้ย
```
