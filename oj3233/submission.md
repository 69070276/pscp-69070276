...
```text
Input:
รับหมวดตัวอักษรและหมายเลข 5 หลักของเลขรางวัล จากนั้นรับหมวดตัวอักษรและหมายเลข 5 หลักของลอตเตอรี่ที่ซื้อ
Output:
แสดงจำนวนเงินรางวัลที่ได้รับ ถ้าไม่ถูกรางวัลให้แสดง 0
Constraints:
ต้องตรวจทั้งตัวอักษร เลขทั้งหมด และเลขท้าย 2 หรือ 3 ตัว โดยต้องเลือกเฉพาะรางวัลที่มีมูลค่าสูงที่สุดเมื่อเข้าได้หลายเงื่อนไข
```
...
```text
Step1: รับหมวดตัวอักษรและหมายเลขรางวัลที่ออก
Step2: รับหมวดตัวอักษรและหมายเลขของลอตเตอรี่ที่ซื้อ
Step3: ตรวจจากรางวัลสูงสุดก่อนว่าตรงทั้งตัวอักษรและเลขมั้ย
Step4: ถ้าไม่ตรง ให้ตรวจเลขทั้งหมดและเลขท้าย 3 ตัว หรือ 2 ตัวตามลำดับ
Step5: ตรวจกรณีตัวอักษรตรงอย่างเดียว
Step6: ถ้าไม่เข้าเงื่อนไขใดเลย ให้รางวัลเป็น 0
Step7: แสดงเงินรางวัลที่ได้
```
