...
```text
Input:
มีทั้งหมด 5 บรรทัดเสมอ
แต่ละบรรทัดอาจมีความยาวแตกต่างกัน และอาจเป็นบรรทัดว่างได้
ตัวอักษรที่โจทย์อนุญาตคือ a-z, A-Z, 0-9 และ space
ช่องว่างที่อยู่ท้ายบรรทัดของอินพุตไม่ถือเป็นส่วนหนึ่งของข้อความ
Output:
ต้องแสดงผล 7 บรรทัด
บรรทัดแรกเป็นกรอบด้านบน
ตรงกลางมีข้อความ 5 บรรทัด
บรรทัดสุดท้ายเป็นกรอบด้านล่าง
Constraints:
ความยาวของข้อความที่ยาวที่สุดจากทั้ง 5 บรรทัด แล้วใช้ความยาวนั้นเป็นความกว้างของพื้นที่ข้อความภายในกรอบ
```
...
```text
Step1: รับข้อความเข้ามาทีละบรรทัดจนครบ 5 บรรทัด
Step2: ตัดช่องว่างที่อยู่ท้ายแต่ละบรรทัดออก
Step3: ตรวจหาว่าจากทั้ง 5 บรรทัด บรรทัดไหนมีความยาวมากที่สุด
Step4: ใช้ความยาวสูงสุดที่หาได้เป็นความกว้างของพื้นที่สำหรับแสดงข้อความ
Step5: สร้างกรอบด้านบนและด้านล่างด้วย * โดยให้มีความยาวเท่ากับพื้นที่ข้อความ + ช่องว่างด้านซ้ายและขวา
Step6: แสดงข้อความทีละบรรทัด โดยมีช่องว่าง 1 ช่องระหว่างข้อความกับกรอบทั้งสองด้าน และเติมช่องว่างหลังข้อความที่สั้นกว่าให้เท่ากับความยาวสูงสุด
Step7: พิมพ์กรอบด้านล่างเหมือนกับกรอบด้านบน
```
...
```text
เหมือนกับวิธีแรก เพราะเป็นวิธีที่เข้าใจง่าย
```
