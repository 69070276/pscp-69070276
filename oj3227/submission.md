...
```text
Input:
รับแต้มไพ่ เช่น A, J, Q, K หรือเลข 2-10 แล้วตามด้วยสัญลักษณ์ D, H, S, C
Output:
แสดงชื่อเต็มของไพ่ เช่น QS จะได้ queen of spades
Constraints:
ต้องรองรับทั้งตัวพิมพ์เล็กและตัวพิมพ์ใหญ่ และถ้าเป็นเลข 2-10 ให้แสดงเลขนั้นเหมือนเดิม
```
...
```text
Step1: รับข้อมูลไพ่เข้ามา
Step2: แยกแต้มไพ่กับสัญลักษณ์ไพ่
Step3: แปลง A, J, Q, K เป็น ace, jack, queen, king
Step4: แปลง D, H, S, C เป็น diamonds, hearts, spades, clubs
Step5: พิมพ์ชื่อไพ่ในรูปแบบ แต้ม of กลุ่มไพ่
```
...
```text
เหมือนวิธีแรก คือแยกข้อมูลไพ่เป็นแต้มกับสัญลักษณ์ แล้วใช้ dict แปลงเป็นชื่อเต็ม
```
