...
```text
Input:
ค่าอุณหภูมิ รับหน่วยของอุณหภูมิ หน่วยที่จะแปลงเป็น
Output:
อุณหภูมิในหน่วยที่แปลงมา
Constraints:
ต้องใช้สูตรตามที่โจทย์กำหนด
```
...
```text
Step 1:รับinput
Step 2:เอาไปใช้ตามสูตร
Step 3:printออกมาตามหน่วยของinputตัวที่3
```
...
```text
เหมือนกับแบบแรก เพราะเป็นวิธีที่ดูเข้าใจง่าย
```
