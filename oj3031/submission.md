...
```text
Input:
บรรทัดแรก รับจำนวนเต็ม S และ N
S คือพื้นที่ที่น้ำหมึกแผ่เพิ่มใน 1 วินาที
N คือจำนวนบ้านที่ต้องตอบ
อีก N บรรทัด รับจำนวนเต็ม Xi และ Yi ซึ่งเป็นพิกัดของบ้านแต่ละหลัง

Output:
พิมพ์คำตอบทั้งหมด N บรรทัด
แต่ละบรรทัดเป็นวินาทีแรกที่น้ำหมึกแผ่มาถึงบ้านหลังนั้น
ถ้าเวลาที่คำนวณได้ไม่เป็นจำนวนเต็ม ให้ปัดขึ้นเป็นจำนวนเต็มถัดไป
...
0 <= Xi, Yi <= 10000
ให้ใช้ค่า Pi = 3.1416
บ้านจะถูกน้ำท่วมเมื่อรัศมีของวงกลมขยายมาถึงหรือเกินระยะจากจุดกำเนิด (0,0) ถึงพิกัดของบ้านนั้น จึงต้องคำนวณจากระยะทางของบ้านและความสัมพันธ์ระหว่างพื้นที่วงกลมกับเวลา ก่อนปัดเวลาขึ้นเป็นจำนวนเต็มหากจำเป็น
```
...
```text
Step1: รับค่า S และ N แล้ววนรับพิกัดบ้าน (x, y) ทีละหลัง
Step2: คำนวณเวลาที่น้ำหมึกแผ่ถึงบ้านด้วยสูตร t = (3.1416 x (x^2 + y^2)) / S
Step3: ปัดเวลาขึ้นเป็นจำนวนเต็มถ้าไม่ลงตัว แล้วพิมพ์ผลลัพธ์ของแต่ละบ้านออกมาทีละบรรทัด
```
...
```text
เหมือนวิธีแรก เพราะคิดว่าทำง่ายที่สุด
```
...
```text
เช็คOutputว่าเหมือนtestcaseมั้ย
```
