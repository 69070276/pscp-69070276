...
```text
Input:
บรรทัดที่ 1: ตัวอักษร Y หรือ N บอกว่าเป็นสมาชิกไหม
บรรทัดที่ 2: จำนวนเต็ม n คือจำนวนรายการสินค้าที่ซื้อ
บรรทัดที่ 3 ถึง (2+n): ราคาสินค้าแต่ละชิ้น ทีละบรรทัด (เป็นเลขจำนวนจริงได้)
Output:
ยอดสุทธิหลังหักส่วนลด แสดงเป็นทศนิยม 2 ตำแหน่งเสมอ
Constraints:
Y ลด 5% เสมอ, N ลด 3% เฉพาะยอด≥500
```
...
```text
Step 1: อ่านสถานะสมาชิก (Y/N)
Step 2: อ่านจำนวนรายการ n
Step 3: วนอ่านราคาสินค้า n บรรทัด รวมเป็นยอดรวม
Step 4: ถ้าเป็นสมาชิก ลด 5% / ถ้าไม่ใช่แต่ยอด≥500 ลด 3% / นอกนั้นไม่ลด
Step 5: ปัดเศษยอดสุทธิเป็นทศนิยม 2 ตำแหน่ง
Step 6: ส่งoutput
```
...
```text
เหมือนวิธีแรก เพราะใช้สูตรที่อิงจากที่โจทย์กำหนด
```
