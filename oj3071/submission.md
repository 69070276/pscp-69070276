...
Constraints:
A < B
ต้องดูจำนวนเต็มทุกตัวในช่วงตั้งแต่ A ถึง B รวมทั้งสองค่า
ค่าเศษ r ต้องน้อยกว่า d
ใช้การหารเอาเศษเพื่อตรวจสอบว่าจำนวนใดมีเศษตรงตามที่กำหนด
ถ้าไม่มีจำนวนที่ตรงเงื่อนไข ให้ตอบ 0
```
...
Step2: ตรวจสอบจำนวนเต็มทุกค่าตั้งแต่ a ถึง b และเช็กว่าจำนวนนั้นหารด้วย d แล้วเหลือเศษ r มั้ย
Step3: นับจำนวนค่าที่ตรงเงื่อนไข แล้วพิมพ์จำนวนที่นับได้ออกมาเป็นคำตอบ
```
...
```text
เหมือนวิธีแรกเพราะเป็นวิธีที่เข้าใจที่สุด
```
