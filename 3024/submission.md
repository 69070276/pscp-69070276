...
```text
Input:
รับinput2ตัว บรรทัดที่ 1: คะแนนรวมของทั้งสามคน
           บรรทัดที่ 2: คะแนนสูงสุดของทั้งสามคนนี้
Output:
Surprising ถ้ามีโอกาส
Not surprising ถ้าไม่มีโอกาส
Constraints:
เงื่อนไข Surprising คือช่องว่างระหว่างคะแนนสูงสุดกับคะแนนต่ำสุดที่เป็นไปได้ ต้องเกิน 2 คะแนน
```
