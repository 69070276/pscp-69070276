...
Step 2: หาแถว r และตำแหน่ง p ของห้อง N แถว r จบที่ห้องหมายเลข r*r
Step 3: ถ้า p เป็นเลขคู่ ให้จำนวนกำแพง = 2*(r-1)-1 ถ้าไม่ใช่ให้ = 2*(r-1)
Step 4: พิมพ์จำนวนกำแพง ถ้า N=1 ให้พิมพ์ 0
```
...
```text
เหมือนวิธีแรก เพราะสูตรดูเข้าใจง่าย
```
